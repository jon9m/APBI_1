...
export class InspectionDtlFormComponent implements OnInit, OnDestroy {
  ...
  private initForm() {
    ...
    this.inspectiondetailsform = this.fb.group({
      ...
      // '1053': '',
      // '1054': '',
      // 'hallways_recommendations_list': this.fb.array([]),
      // '1061': '',
      // '1062': '',
      // '1063': '',
      // '1064': '',
      ...
      // '1161': '',
      // '1162': '',
      // 'kitchen_recommendations_list': this.fb.array([]),
      // '1169': '',
      // '1170': '',
      // '1171': '',
      // '1172': '',
      ...
      // '1233': '',
      // '1234': '',
      // 'laundry_recommendations_list': this.fb.array([]),
      // '1253': '',
      // '1254': '',
      // '1255': '',
      // '1256': '',
      ...
      // '1485': '',
      // '1486': '',
      // 'bedrooms_recommendations_list': this.fb.array([]),
      // '1499': '',
      // '1500': '',
      // '1501': '',
      // '1502': '',
      ...
      // '1629': '',
      // '1630': '',
      // 'bathrooms_recommendations_list': this.fb.array([]),
      // '1643': '',
      // '1644': '',
      // '1645': '',
      // '1646': '',
      ...
      // '1773': '',
      // '1774': '',
      // 'ensuite_recommendations_list': this.fb.array([]),
      // '1787': '',
      // '1788': '',
      // '1789': '',
      // '1790': '',
      ...
      // '1959': '',
      // '1960': '',
      // 'external_recommendations_list': this.fb.array([]),
      // 'summary': '',
      // 'major_defects': '',
      // 'major_defects_comment': '',
      // 'structural_defects': '',
    ...
    //   if (this.reportType != this.insp_type_pest_and_termite_inspection) {
    //     this.addControlsToForm(this.inspectiondetailsform, smoke_detectors_fitted_form);
    //   }
  ...
  formsMapper = {
    ...
    'furnished_and_extension_form': [1, 2, 3, 6, 7, 10, 11],
